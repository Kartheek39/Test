...
Dpackage=$( wget --timeout=90 -q -O $segments "http://directreadout.sci.gsfc.nasa.gov/download_package.cfm?softwareid=304&uniqueid=33FEF1DC-DD9F-C80F-9F1DAD56A339BCC4" )
foo=$?
if [ $foo -ne 0 ]
then
err_msg
