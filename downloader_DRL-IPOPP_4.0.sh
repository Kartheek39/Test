...
Dpackage=$( wget --timeout=90 -q -O $segments "http://directreadout.sci.gsfc.nasa.gov/download_package.cfm?softwareid=304&uniqueid=0C166118-D5E3-BF5E-960B7B7193B8F770" )
foo=$?
if [ $foo -ne 0 ]
then
err_msg
