...
Dpackage=$( wget --timeout=90 -q -O $segments "http://directreadout.sci.gsfc.nasa.gov/download_package.cfm?softwareid=320&uniqueid=24307AE2-99A8-24A8-AF807247E68C486D" )
foo=$?
if [ $foo -ne 0 ]
then
err_msg
